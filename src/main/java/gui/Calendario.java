 ...
 * @version $Id: Calendario.java,v 1.5 2004/02/09 03:33:45 ian Exp $
 */
public class Calendario extends JPanel {
  ...
  /** Compute which days to put where, in the Calendario panel */
  protected void recompute() {
    // System.out.println("Calendario::recompute: " + yy + ":" + mm + ":" + dd);
    if (mm < 0 || mm > 11)
...
//    if (isLeap(calendar.get(Calendar.YEAR)) && mm > 1)
  ...
  public void setDate(int yy, int mm, int dd) {
    // System.out.println("Calendario::setDate");
    this.yy = yy;
